...
public class GUI_TrangChu extends JFrame {
	...
	public GUI_TrangChu() {
		...
		ImageIcon originalIcon = new ImageIcon(GUI_TrangChu.class.getResource("/img/pfejindbf.jfif"));
		Image originalImage = originalIcon.getImage();

		// Lấy kích thước khung (ở đây contentPane có size gần như 732x467)
		int width = 732;
		int height = 467;

		// Scale ảnh theo kích thước khung
